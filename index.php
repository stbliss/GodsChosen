...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>God's Chosen Erector Co LTD</title>
    ...
    <body>
            ...
            <nav class="navbar bootsnav">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href=""><img class="logo" src=".../../photos/Erector Logo.jpg" alt=""></a>
                    </div>
                    <!-- Navigation -->
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src=".../../photos/testimonial_bg.jpg" alt="Construction">
                        <div class="overlay">
                    ...
                    <div class="item">
                        <img src=".../../photos/slider_img.jpg" alt="Construction">
                        <div class="overlay">
                            <div class="carousel-caption">
                                <h3>We are Certified Engineers</h3>
                                <h1>Construction Services</h1>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="head_title">
                            <h2>WHY CHOOSE US?</h2>
                            <p>Here at God's Chosen Erector Co. Ltd we are passionate about delivering quality with professionalism, We are committed to meeting and exceeding our client's expectations with strong focus on customer satisfaction through TEAMWORK.</p>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="why_us_item">
                            ...
                            <p>We deliver quality services to enable us to meet and exceed clients expectations in safety environment.</p> 
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="why_us_item">
                            ...
                            <p>Time has been one of our many superpowers here at God's Chosen Erector Co. Ltd, We are exceptional in all aspect.</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="why_us_item">
                            ...
                            <p>our passion for enovation has been our drive, we pay attention to every straights and curves in the course of carrying out our projects. </p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="why_us_item">
                            ...
                            <p>We are well trained, youthful and skillful Professionals that delivers master pieces in all sections of our projects.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="portfolio">
            <div class="container portfolio_area text-center">
                ...
                <p>Here are some of our completed jobs in recent time, Made with quality, passion and love while maintaining course to meet our clients demand</p>
                ...
                <div class="grid">
                    ...
                    <div class="grid-item plumbing isolation">
                        <img alt="" src=".../../photos/SAM_0622.JPG" >
                        <div class="portfolio_hover_area">
                            <a class="fancybox" href=".../../photos/SAM_0622.JPG" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet"><span class="fa fa-search"></span></a>
                            <a href="#"><span class="fa fa-link"></span></a>
                        </div>  
                    </div>
